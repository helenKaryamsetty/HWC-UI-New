...
export class DoctorService {
  ...
  getGenericVitals(beneficiary: any) {
  ...
  getGenericVitalsForMMULabReport(beneficiary: any) {
    const otherDetails = Object.assign({}, beneficiary, {
  ...
  updateGeneralVitals(patientVitalsForm: any, visitCategory: any) {
    const vanID = JSON.parse(
      localStorage.getItem('serviceLineDetails') || '{}',
    ).vanID;
    const parkingPlaceID = JSON.parse(
  ...
  updateNeonatalVitals(neonatalVitalsForm: any, visitCategory: any) {
    const vanID = JSON.parse(
      localStorage.getItem('serviceLineDetails') || '{}',
    ).vanID;
    const parkingPlaceID = JSON.parse(
  ...
  postDoctorPNCDetails(
    ...
    return this.http
      ...
      .pipe(map((res: any) => res.json(), shareReplay(1)));
  }
  ...
  */
  ...
  downloadSign(userID: any) {
    ...
    //updated by Arun - new structure added
    return this.http
      .get(environment.downloadSignUrl + userID, {
  ...
  getAssessment(benRegID: any) {
    ...
    return this.http
      .get(environment.getAssessmentIdUrl + '/' + benRegID)
      .pipe(map((res: any) => res.json()));
  }

  getAssessmentDet(assessmentId: any) {
    return this.http
      .get(environment.getAssessmentUrl + '/' + assessmentId)
      .pipe(map((res: any) => res.json()));
  }
}
